...
import { HASOCDataSourceOptions, HASOCSecureJsonData } from '../types';

interface Props extends DataSourcePluginOptionsEditorProps<HASOCDataSourceOptions, HASOCSecureJsonData> {}
...
export function ConfigEditor(props: Props) {
  ...
  return (
    <>
      <InlineField label="Instance URL" labelWidth={16} interactive tooltip="The Home Assistant instance HA SOC is installed on">
        <Input
      ...
      <InlineField
        ...
        labelWidth={16}
        interactive
        tooltip="A long-lived access token for a Home Assistant admin user (HA SOC requires admin, and by default owner)"
      >
        <SecretInput
          required
