...
import { UnifiNetworkDataSourceOptions, UnifiNetworkSecureJsonData } from '../types';

interface Props extends DataSourcePluginOptionsEditorProps<UnifiNetworkDataSourceOptions, UnifiNetworkSecureJsonData> {}
...
export function ConfigEditor(props: Props) {
  ...
  return (
    <>
      <InlineField label="Controller host" labelWidth={18} interactive tooltip="e.g. 192.168.1.1 or https://192.168.1.1">
        <Input
      ...
      <InlineField
        ...
        labelWidth={18}
        interactive
        tooltip="A local Integration API key from the controller's Settings > Control Plane > Integrations"
      >
        <SecretInput
          required
